...
# dasel put 'app_state.gov.params.voting_period' -t string -v "" -f $genesisHome/config/genesis.json
# dasel put '.app_state.gov.params.expedited_voting_period' -t string -v "3600s" -f $genesisHome/config/genesis.json
